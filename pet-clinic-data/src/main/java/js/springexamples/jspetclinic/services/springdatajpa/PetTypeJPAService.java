...
import js.springexamples.jspetclinic.repositories.PetTypeRepository;
...
public class PetTypeJPAService implements PetTypeService {
    ...
    public PetType findById(Long aLong) {
        return petTypeRepository.findById(aLong).isPresent() ? petTypeRepository.findById(aLong).get() : null;
    }
